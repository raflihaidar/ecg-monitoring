...
#define WIFISSID "Ralph" // Enter WifiSSID here
#define PASSWORD "12345678" // Enter password here
#define TOKEN "BBUS-dmRPqVer9wRo6Vg4fh2HwNCKFKJ6pY" // Ubidots' TOKEN
#define MQTT_CLIENT_NAME "raflihaidar" // MQTT client Name
// * Define Constants
